...
| Experiment | Best val_accuracy | Best val_loss |
|---|---|---|
...
Training was run on Google Colab CPU. Both experiments completed on the full dataset. Feature Extraction reached 91.16% validation accuracy and Fine-tuning reached 88.32%.
